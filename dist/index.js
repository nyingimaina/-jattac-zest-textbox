...
var HelperTextDisplay = function (_a) {
    ...
    if (!helperTextNode) {
        ...
        if (positioning === "reserved") {
            return (jsxRuntime.jsx("div", { className: "".concat(styles.helperText, " ").concat(styles.reservedSpace, " ").concat(className || "") }));
        }
        return null; // For 'absolute' positioning, return null if no text
    }
    return (jsxRuntime.jsx("div", { className: "".concat(styles.helperText, " ").concat(className || "", " ").concat(styles[positioning]), children: helperTextNode }));
};
