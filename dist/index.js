...
var ZestTextbox = function (props) {
    ...
    var _k = react.useState(false), isDark = _k[0], setIsDark = _k[1];
    var _l = react.useState(false), isPasswordVisible = _l[0], setIsPasswordVisible = _l[1];
    var _m = react.useState(null), helperTextNode = _m[0], setHelperTextNode = _m[1];
